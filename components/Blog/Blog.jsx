...
export default function Blog() {
  ...
  useEffect(() => {
    if (localStorage.getItem("token")) {
      axios
        .post(`${REACT_APP_BASE_URL}/api/user/data`, {
    ...
    axios
      .get(`${REACT_APP_BASE_URL}/api/user/post/${id}`)
      .then((res) => {
  ...
  const handleLike = (id) => {
    if (loggedIn) {
      if (!liked) {
        axios
          .post(`${REACT_APP_BASE_URL}/api/user/post/like/${id}`, {
            user_id: userId,
          })
          .then((res) => {
            setBlog(res.data.blog);
        ...
        axios
          .post(
            `${REACT_APP_BASE_URL}/api/user/post/unlike/${id}`,
            {
              user_id: userId,
            }
          )
  ...
  const addComment = (id) => {
    axios
      .post(`${REACT_APP_BASE_URL}/api/user/post/comment/${id}`, {
        user_id: userId,
